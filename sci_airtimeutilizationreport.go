...
func NewSCIAirtimeUtilizationReport5trendChartDataType() *SCIAirtimeUtilizationReport5trendChartDataType {
	m := new(SCIAirtimeUtilizationReport5trendChartDataType)
	return m
}
