...
func (s *SwitchMSwitchAccessControlListService) AddAccessControls(ctx context.Context) (*common.CreateResult, error) {
}

func (s *SwitchMSwitchAccessControlListService) FindAccessControlsById(ctx context.Context, id string) (*aclconfig.ACLConfig, error) {
}

func (s *SwitchMSwitchAccessControlListService) FindAccessControlsByQueryCriteria(ctx context.Context) (*aclconfig.ACLConfigsQueryResult, error) {
}
