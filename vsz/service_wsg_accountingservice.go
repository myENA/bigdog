...
func (s *WSGAccountingServiceService) DeleteServicesAcct (ctx context.Context) error {
}

func (s *WSGAccountingServiceService) DeleteServicesAcctById (ctx context.Context, id string) error {
}

func (s *WSGAccountingServiceService) DeleteServicesAcctRadiusSecondaryById (ctx context.Context, id string) error {
}

func (s *WSGAccountingServiceService) DeleteServicesAcctRadiusStandbyPrimaryById (ctx context.Context, id string) error {
}
