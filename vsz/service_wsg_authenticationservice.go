...
func (s *WSGAuthenticationServiceService) DeleteServicesAuth (ctx context.Context) error {
}

func (s *WSGAuthenticationServiceService) DeleteServicesAuthById (ctx context.Context, id string) error {
}

func (s *WSGAuthenticationServiceService) DeleteServicesAuthRadiusSecondaryById (ctx context.Context, id string) error {
}

func (s *WSGAuthenticationServiceService) DeleteServicesAuthRadiusStandbyPrimaryById (ctx context.Context, id string) error {
}
