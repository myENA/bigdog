...
func (s *WSGL2oGREService) FindProfilesL2ogreById(ctx context.Context, id string) (*profile.L2oGREProfile, error) {
}

func (s *WSGL2oGREService) FindProfilesL2ogreByQueryCriteria(ctx context.Context) (*profile.L2oGREProfileList, error) {
}
