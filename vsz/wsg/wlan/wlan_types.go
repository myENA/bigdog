...
type CreateGuestAccessWLAN struct {
	...
	AccountingServiceOrProfile *AccountingServiceOrProfile `json:"accountingServiceOrProfile,omitempty"`
	AdvancedOptions            *AdvancedOptions            `json:"advancedOptions,omitempty"`
	AuthServiceOrProfile       *AuthServiceOrProfile       `json:"authServiceOrProfile,omitempty"`
	...
	CoreTunnelProfile          *CoreTunnelProfile          `json:"coreTunnelProfile,omitempty"`
	...
	QosMaps                    []*QosMaps                  `json:"qosMaps,omitempty"`
	RadiusOptions              *RadiusOptions              `json:"radiusOptions,omitempty"`
