...
type WSGAPQueryListAPIResponse struct {
	*RawAPIResponse
	Data *WSGAPQueryList
}

func newWSGAPQueryListAPIResponse(src APISource, meta APIResponseMeta, body io.ReadCloser) APIResponse {
	r := new(WSGAPQueryListAPIResponse)
